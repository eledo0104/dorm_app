...
class FloorLeaderEditProfileScreen extends StatefulWidget {
  final UserModel user;
  const FloorLeaderEditProfileScreen({super.key, required this.user});

  @override
  State<FloorLeaderEditProfileScreen> createState() => _FloorLeaderEditProfileScreenState();
}

class _FloorLeaderEditProfileScreenState extends State<FloorLeaderEditProfileScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            _buildTextField("Room Number", _roomController, Icons.room_outlined),
          ],
        ),
      ),
    );
